...
def main():
    parser = ArgumentParser(
        description="Find all the Modules and copy outputs.tf from root to module paths.",
    )
    parser.add_argument(
        "--outputs",
        type=str,
        default="outputs.tf",
        help="Path to source outputs.tf",
    )
    parser.add_argument(
        "--modules",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="local.",
        help="Output string to find and replace",
    )
    parser.add_argument(
        "--replace",
        type=str,
        default="module.case.",
        help="String to use when replacing",
    )
